...
export const Button = forwardRef<HTMLButtonElement, ButtonProps>(
  ({ className, variant = 'primary', size = 'md', isLoading, children, disabled, ...props }, ref) => {
    ...
    const variants = {
      primary: 'bg-gradient-to-r from-gold to-gold-muted text-white hover:shadow-lg hover:-translate-y-0.5 focus:ring-gold',
      secondary: 'bg-marble-dark text-charcoal hover:bg-marble focus:ring-slate',
      outline: 'border border-gold text-gold hover:bg-gold hover:text-white focus:ring-gold',
      ghost: 'text-slate hover:bg-marble-dark hover:text-charcoal focus:ring-slate',
