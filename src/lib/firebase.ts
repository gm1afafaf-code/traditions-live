...
// Firebase client-side config - these are safe to expose (security is handled by Firestore rules)
// Environment variables take precedence if configured in Vercel
